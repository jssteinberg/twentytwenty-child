 ...
 */
function twentytwentychild_site_logo( $args = array(), $echo = true ) {
	...
	$defaults = array(
		'logo'        => '%1$s<span aria-hidden="true"><a href="/">%2$s</a></span>',
	 ...
	 */
	$html = apply_filters( 'twentytwentychild_site_logo', $html, $args, $classname, $contents );
